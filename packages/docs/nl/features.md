...
- **Open-tracking** — een onzichtbare pixel vertelt je wanneer een klant je e-mail opent
...
- **UBL XML** — Universal Business Language voor geautomatiseerde e-facturatie
- **Peppol XML** — Europese e-facturatiestandaard
